...
class ComboSliderInt extends StatefulWidget {
  ComboSliderInt(this.label, this.value, this.minValue, this.maxValue, this.onChangedCallBack, {Key key})
      : super(key: key);
  ...
  @override
  _ComboSliderIntState createState() => _ComboSliderIntState();
}

class _ComboSliderIntState extends State<ComboSliderInt> {
  String valueText;
