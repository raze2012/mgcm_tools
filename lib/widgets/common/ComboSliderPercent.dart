...
class ComboSliderPercent extends StatefulWidget {
  ComboSliderPercent(this.label, this.value, this.minValue, this.maxValue, this.onChangedCallBack, {Key key})
      : super(key: key);
  ...
  @override
  _ComboSliderPercentState createState() => _ComboSliderPercentState();
}

class _ComboSliderPercentState extends State<ComboSliderPercent> {
  String valueText;
  ...
  Widget build(BuildContext context) {
    int divisions = (widget.maxValue - widget.minValue).floor();
                  ...
                  child: Row(
                    children: [
                      HoldDetector(
                        ...
                        onHold: () => onChanged(widget.value - 1),
                        child: ElevatedButton(
                          ...
                          onPressed: () => onChanged(widget.value - 1),
                          child: Text(
                            "-",
                            style: Theme.of(context).textTheme.headline5.copyWith(color: Colors.white),
                          ),
                      ...
                      Expanded(
                        ...
                        child: TextField(
                          ...
                          onSubmitted: (newText) {
                            ...
                            double parsedValue = double.tryParse(newText.substring(0, newText.length - 1));
                            if (parsedValue != null) {
