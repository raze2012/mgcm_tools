...
class DressesPageSmall extends StatefulWidget {
  DressesPageSmall({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _DressesPageSmallState createState() => _DressesPageSmallState();
}

class _DressesPageSmallState extends State<DressesPageSmall> {
  SearchBar searchBar;
            ...
            builder: (context) {
              return StatefulBuilder(builder: (context, setState) {
                return Dialog(
                    ...
                    child: DressFilterMenu(filterModel, (model) {
                      _update();
                    }));
              });
            },
